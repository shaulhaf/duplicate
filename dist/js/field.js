...
Nova.booting(function (Vue, router) {
    Vue.component('index-duplicate-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    onClick: function onClick() {
      ...
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post("/nova-vendor/jackabox/nova-duplicate", {
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "cursor-pointer text-70 hover:text-primary no-underline flex items-center",
      attrs: { href: "" },
      on: {
    ...
    [
      ...
      _vm._v(" "),
      this.field.showText ? _c("span", [_vm._v("- Duplicate")]) : _vm._e()
    ]
  )
}
var staticRenderFns = []
